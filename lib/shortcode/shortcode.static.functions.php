 ...
 */
function zp_static_clean_param($param)
{
 ...
 */
function zp_static_get_year($date, $yesnd = false)
{
    $date_return = false;
 ...
 */
function zp_static_subval_sort($item_arr, $sortby, $order)
{
    // Format sort order
    ...
    if ($sortby == "author"
        ...
        foreach ($item_arr as $key => $val) {
            ...
            $date[$key] = zp_static_date_format($zpdate);
        }
 ...
 */
function zp_static_date_format($date)
{
    // Set up search lists
